...
def CSV_reader_heart():
    ...
    heart = pd.read_csv('C:/Users/Soumyajit/OneDrive/Desktop/heart_final.csv')
    # print(f'HEAD : \n{heart.head()}')
    return heart

def divider(heart,mypal):
...
def variable_distributor(heart,mypal):
...
def categorial_features_distributer(categorical_features,df1):
...
def numerical_features_distributor(numerical_features,df1):
...
def function_caller(heart,categorical_features, numerical_features, mypal,df1):
    ...
    variable_distributor(heart,mypal)
    categorial_features_distributer(categorical_features,df1)
    numerical_features_distributor(numerical_features,df1)
...
categorical_features, numerical_features, mypal = divider(heart,mypal)
