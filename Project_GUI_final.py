...
from variable_file import values_repository, sex_list, chestPainTypeList, fastinBS_list, restingECG_list, exerciseAngina_list, st_Slope_list, classifier_catboost
